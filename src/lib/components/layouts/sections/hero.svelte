...
>
  ...
  <div class="relative px-6 sm:px-8 lg:px-10">
    <div
    ...
    >
      <div class="py-6 text-left sm:py-16 lg:py-20">
        ...
        <div class="mb-8 hidden flex-wrap gap-2.5 sm:flex">
          <span
      ...
      >
        ...
        >
          ...
          <div
            class="brand-outline-card relative rounded-[3.65rem] bg-brand-shell p-2.5 shadow-2xl ring-1 ring-primary-900/25"
          >
